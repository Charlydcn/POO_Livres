...
<body>
    ...
    <?php
        ...
        $simetierre = new Book("Simetierre", 374, 1983, 15.00, $stephenking);   // (ces livres sont instanciés dans la classe Book, avec comme auteur, l'objet $stephenking de la classe Author)
        ...
        $hp2 = new Book("Harry Potter et la chambre des secrets", 364, 1998, 9.30, $jkrowling);     // (ces livres sont instanciés dans la classe Book, avec comme auteur, l'objet $jkrowling de la classe Author)
        $hp3 = new Book("Harry Potter et le Prisonnier d'Azkaban", 474, 1999, 10.80, $jkrowling);
